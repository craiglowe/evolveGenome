...
A tool that takes a fasta file and "evolves" the sequence by adding substitutions, insertions, and deletions.


Installation
============

This code uses the Kent libraries from UCSC, so those must be installed to compile evolveGenome.
...
<li> Compile evolveGenome
<ol>
<li> Edit the evolveGenome makefile so that it points to the kent libraries on your system.  These
...
<li> Compile evolveGenome:<br />
make

<li> Running evolveGenome with no parameters should give a brief help message.
</ol>
</ol>
